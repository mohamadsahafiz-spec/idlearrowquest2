...
const WORLDS: Array[Dictionary] = [
	{"id": 1, "name": "Royal Kingdom", "max_stages": 10},
	{"id": 2, "name": "Enchanted Forest", "max_stages": 30},
	{"id": 3, "name": "Frozen Kingdom", "max_stages": 60},
	{"id": 4, "name": "Gothic Realm", "max_stages": 100},
	{"id": 5, "name": "Infernal Realm", "max_stages": 250},
	{"id": 6, "name": "Celestial Realm", "max_stages": 500}
]
...
static func get_max_stages(world_id: int) -> int:
	return int(get_world_info(world_id).get("max_stages", 10))
